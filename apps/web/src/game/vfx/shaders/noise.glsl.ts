 ...
 *
 * Ported from the elemental sandbox — injected into custom VFX materials.
 * Contains: hashes, 3D simplex, fbm, ridged fbm, curl noise, voronoi.
 */
...
/** Ridged multifractal — sharp filaments for flames, cracks, frost fingers. */
...
/** Divergence-free curl noise — swirl particles and flames. */
...
/** Cheap 2D voronoi. x = distance to closest cell, y = cell id hash. */
